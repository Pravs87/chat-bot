...
pwd = os.getcwd()
print pwd
with open(pwd+'/../data/intents.json') as json_data:
...
import detectEntities
def main():
    text = "remind me to validate all test cases tomorrow"
    if len(sys.argv) > 1:
        text = sys.argv[1]
        print text
    ...
    entities = detectEntities.entities(str(intent), text)
